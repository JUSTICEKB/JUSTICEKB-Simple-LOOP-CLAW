...
| 平台 | 文件 |
|------|------|
| macOS Apple Silicon（M 系列） | `Claude-Code-LoopClaw-0.4.5-mac-arm64.dmg` |
| macOS Intel | `Claude-Code-LoopClaw-0.4.5-mac-x64.dmg` |
| Windows x64 | `Claude-Code-LoopClaw-0.4.5-win-x64.exe` |
| Windows ARM64 | `Claude-Code-LoopClaw-0.4.5-win-arm64.exe` |
| Linux x64 | `Claude-Code-LoopClaw-0.4.5-linux-x86_64.AppImage` 或 `Claude-Code-LoopClaw-0.4.5-linux-amd64.deb` |
| Linux ARM64 | `Claude-Code-LoopClaw-0.4.5-linux-arm64.AppImage` 或 `Claude-Code-LoopClaw-0.4.5-linux-arm64.deb` |
...
```bash
chmod +x Claude-Code-LoopClaw-0.4.5-linux-x86_64.AppImage
./Claude-Code-LoopClaw-0.4.5-linux-x86_64.AppImage
```

deb：

```bash
sudo apt install ./Claude-Code-LoopClaw-0.4.5-linux-amd64.deb
```
