export const en = {
  ...
  'settings.activity.defaultHandle': 'github.com/NanmiCoder/simple-loop-claw',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes loop-claw; replace documented claude <args> with loop-claw <args>, for example: loop-claw plugin install ... or loop-claw mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: simple-loop-claw-open-tabs, simple-loop-claw-session-runtime, simple-loop-claw-theme, simple-loop-claw-locale, and simple-loop-claw.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/simple-loop-claw/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for simple-loop-claw data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, simple-loop-claw, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.notificationsTestTitle': 'Simple LoopClaw notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local simple-loop-claw traces directory.',
