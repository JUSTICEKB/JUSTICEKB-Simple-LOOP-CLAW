...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'simple-loop-claw.persistence.schemaVersion'
...
const TAB_STORAGE_KEY = 'simple-loop-claw-open-tabs'
const SESSION_RUNTIME_STORAGE_KEY = 'simple-loop-claw-session-runtime'
const THEME_STORAGE_KEY = 'simple-loop-claw-theme'
const LOCALE_STORAGE_KEY = 'simple-loop-claw-locale'
