...
export class DoctorService {
  ...
  private async buildTargets(): Promise<DoctorTarget[]> {
    const targets: DoctorTarget[] = [
      ...
      this.jsonTarget(
        'simple-loop-claw-providers',
        'Managed providers',
        'user',
        path.join(this.configDir, 'simple-loop-claw', 'providers.json'),
      ),
      this.jsonTarget(
        'simple-loop-claw-settings',
        'Managed provider settings',
        'user',
        path.join(this.configDir, 'simple-loop-claw', 'settings.json'),
      ),
      ...
      this.jsonTarget('oauth', 'OAuth tokens', 'user', path.join(this.configDir, 'simple-loop-claw', 'oauth.json')),
      this.jsonTarget(
        'openai-oauth',
        'OpenAI OAuth tokens',
        'user',
        path.join(this.configDir, 'simple-loop-claw', 'openai-oauth.json'),
      ),
    ]
