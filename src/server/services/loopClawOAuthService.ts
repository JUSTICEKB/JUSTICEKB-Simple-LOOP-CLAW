/**
 * LoopClawOAuthService — 桌面端自管 Claude OAuth token
 *
...
export class LoopClawOAuthService {
  ...
  private getOAuthFilePath(): string {
    ...
    return path.join(configDir, 'simple-loop-claw', 'oauth.json')
  }
  ...
  async ensureFreshTokens(): Promise<StoredOAuthTokens | null> {
    ...
    try {
      ...
      logTokenRefreshFailure('[LoopClawOAuthService]', err)
      return null
    }
  }
...
export const loopClawOAuthService = new LoopClawOAuthService()
