...
import { getLoopClawOpenAIOAuthFilePath } from './loopClawOpenAIOAuthService.js'
import {
...
export const OPENAI_OAUTH_PROVIDER_ENV_KEY = 'LOOP_CLAW_OPENAI_OAUTH_PROVIDER'
...
export function buildOpenAIOfficialRuntimeEnv(): Record<string, string> {
  ...
  return {
    ...
    [OPENAI_CODEX_OAUTH_FILE_ENV_KEY]: getLoopClawOpenAIOAuthFilePath(),
