...
export default withMermaid(defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      themeConfig: {
        editLink: {
          pattern: 'https://github.com/NanmiCoder/simple-loop-claw/edit/main/docs/:path',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/NanmiCoder/simple-loop-claw' },
    ],
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright 2026 Simple LoopClaw Contributors',
    },
  },
}))
