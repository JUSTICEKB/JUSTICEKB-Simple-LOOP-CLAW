...
All diagrams use a dark background (#1a1a2e) with Simple LoopClaw orange-blue accent (#FF7A00), consistent with Claude Code's official documentation style.
...
- [Simple LoopClaw Home](/)
- [Memory System Documentation](/en/memory/01-usage-guide)
- [Agent Tool Source Code](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/tools/AgentTool/)
- [Swarm Infrastructure](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/utils/swarm/)
- [Task Management System](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/tasks/)
