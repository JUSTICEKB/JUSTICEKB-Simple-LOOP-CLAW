...
All illustrations use a dark background (#1a1a2e) + Simple LoopClaw orange-blue accent (#FF7A00) style, consistent with the official Claude Code documentation.
...
- [Simple LoopClaw Home](/en/)
- [Memory system source code](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/memdir/)
- [Auto-extraction service](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/services/extractMemories/)
- [AutoDream service](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/services/autoDream/)
- [DreamTask](https://github.com/NanmiCoder/simple-loop-claw/tree/main/src/tasks/DreamTask/)
- [GitHub Issues](https://github.com/NanmiCoder/simple-loop-claw/issues)
